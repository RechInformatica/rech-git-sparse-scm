...
import { GitResourceStateListProvider } from './resources/gitResourceStateListProvider';
...
export function activate(context: vscode.ExtensionContext) {
	...
	let repository = new Repository(new GitResourceStateListProvider());
	repository.init();
	...
	let test = vscode.commands.registerCommand('rech-git-sparse-scm.test', () => {
		vscode.window.showInformationMessage('Executado Comando de Teste!');
		repository.reload();
